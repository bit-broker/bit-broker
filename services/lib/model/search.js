...
module.exports = class Search {
    ...
    // --- regex for starts with

    static starts_with(query) {
        return [ `^${ query }.*$` ];
    }
    ...
    user_org(query) {
        return this.db('users')
               .select(this.db.raw("(properties->>'organization') AS organization"))
               .distinct()
               .whereRaw("(properties->>'organization') ~* ?", Search.starts_with(query))  // case independant
